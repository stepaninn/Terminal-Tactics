#ifndef MYGAMEPROJECT_TIMEPOINTSCOMPONENT_MT_H
#define MYGAMEPROJECT_TIMEPOINTSCOMPONENT_MT_H
...
public:
    ...
    [[nodiscard]] int get_current_points() const override {
    ...
    [[nodiscard]] int get_max_points() const override {
        std::lock_guard<std::mutex> lock(mutex_);
        return max_tp_;
    }
...
#endif //MYGAMEPROJECT_TIMEPOINTSCOMPONENT_MT_H
